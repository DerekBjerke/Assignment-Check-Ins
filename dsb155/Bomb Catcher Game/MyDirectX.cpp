/*
	...
	Desc: The DirectX layer of the application. Provides services such as getting input,
		  monitoring their state, and creating surfaces to display to the device
*/
...
bool XInput_Controller_Found()
{
	...
	// Bug Theory: caps.Type should be checked for specific controller type and subtype codes instead of 0.
