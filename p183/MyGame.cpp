...
Name: Derek Bjerke
Date: 3/25/2016
Desc: Demonstrates animating sprites and affecting their speed and attributes.
...
void Game_Run(HWND window)
{
    ...
    if ( SUCCEEDED(d3ddev->BeginScene()) )
    {
		...
		Sprite_Animate(frame, 0, 29, direction, starttime, 50);
		Sprite_Draw_Frame(explosion, 200, 200, frame, 128, 128, 6);
		if(frame == 29 || frame == 0) direction *= -1;
